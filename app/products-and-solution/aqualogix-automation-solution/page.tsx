...
const Page = () => {
	return (
		<div className='w-full h-full flex flex-col justify-center items-center mt-[3rem] mb-16'>
			...
			<div className=' w-full p-10 border-b-4 flex justify-center items-center'>
				...
				<DownloadButton name='Aqualogix_Brochure.pdf' />
			</div>
			...
			<div className='my-20 flex flex-col justify-start items-center font-titilium text-start w-[85%] space-y-10 bg-[#F4F4F4] py-16 relative overflow-clip'>
				...
				<p className='xsPhone:text-[min(3.5vh,3.5vw)] smTablet:text-[min(2.5vh,2.5vw)] text-neutral-700 leading-relaxed w-[90%] text-justify'>
					...
					We&apos;re not just delivering water; we&apos;re providing
					sustainability, safety, and a better quality of life to thousands of
					families.
				</p>
				...
				<div className='flex flex-col justify-start items-start space-y-6 w-[90%] xsPhone:text-[min(3.5vh,3.5vw)] smTablet:text-[min(2.5vh,2.5vw)] text-neutral-700'>
					...
					<p>
						...
						and WIMS Software in India&apos;s water management sector. Since
						2013, our in-house solutions, AquaLogix and DMTS, have played a
						crucial role in monitoring and maintaining water supply systems
						across over 100,000 villages and 14 cities.
					</p>
					...
					<ul className='list-disc pl-6'>
						...
						<li>
							Emphasis on Leadership: Showcases Desire Energy&apos;s expertise
							in IoT and WIMS.
						</li>
