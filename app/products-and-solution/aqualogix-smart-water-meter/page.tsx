...
import aqualogix_creative_2 from "@/public/asset/products_and_solution/smart_water_meter_2.jpeg";
	...
	return (
		<div className='w-full h-full flex flex-col justify-center items-center mt-[3rem] mb-16'>
			...
			<div className=' w-full p-10 border-b-4 flex justify-center items-center'>
				...
				<DownloadButton name='Smart_Water_Meter_Brochure.pdf' />
			</div>
			...
			<div className='w-[85%] flex gap-2'>
				<Image src={aqualogix_creative_1} alt='' className='w-1/2' />
				<Image src={aqualogix_creative_2} alt='' className='w-1/2' />
			</div>
