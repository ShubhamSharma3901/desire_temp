				...
				<div className='grid xsPhone:grid-cols-1 smLaptop:grid-cols-2 xsPhone:gap-10 smLaptop:gap-0 w-full h-full justify-center items-start'>
					...
					<div className='w-full  flex justify-between h-full items-start text-start flex-col gap-10'>
						<div className='space-y-8'>
							...
							<p className='text-[#FFFFFF] xsPhone:text-[min(3.5vh,3.5vw)] smTablet:text-[min(2.8vh,2.8vw)]'>
						...
						<div className='flex '>
							<Link
								...
								className='smTablet:text-[min(2vh,2vw)] xsPhone:text-[min(3vh,3vw)]  xsPhone:py-2 text-[#D5F590] bg-[#003300] hover:bg-[#D5F590] hover:text-[#003300] transition tracking-normal font-normal flex justify-center items-center py-3 px-6 gap-1 font-figtree'>
								Know More{" "}
								<ArrowUpRight
