			...
			<footer className='bg-gradient-to-b from-[#085C2C] to-[#003300] text-white'>
				<div className='mx-auto w-[85%] px-4 xsPhone:py-8 smLaptop:py-[4rem]'>
					<div className='flex xsPhone:flex-col tablet:flex-row'>
						<div className='mb-6 md:mb-0 flex flex-col justify-start items-start gap-[4rem] font-titilium text-white/80 tablet:w-[50%] xsPhone:w-full'>
						...
						<div className='grid tablet:grid-cols-3 xsPhone:grid-cols-1 gap-8 tablet:w-[85%] xsPhone:w-full'>
							<div className=''>
								...
								<Separator className='tablet:w-[90%] xsPhone:w-full h-[2px] bg-white mb-7' />
							...
							<div>
								...
								<div className='text-white font-medium  font-titilium flex justify-start gap-8 items-center'>
									<a
										href='https://www.instagram.com/desireenergy/'
										className='hover:underline hover:text-[#D5F590] transition'>
										<BsInstagram className='h-auto w-6' />
									</a>

									<a
										href='https://www.facebook.com/desireescosolar/'
										className='hover:underline hover:text-[#D5F590] transition'>
										<BsMeta className='h-auto w-6' />
									</a>

									<a
										href='https://www.youtube.com/@DESIRE.ENERGY'
										className='hover:underline hover:text-[#D5F590] transition'>
										<BsYoutube className='h-auto w-6' />
									</a>

									<a
										href='https://in.linkedin.com/in/desire-energy-485788103'
										className='hover:underline hover:text-[#D5F590] transition'>
					...
					<div className='sm:flex sm:items-center sm:justify-between text-white/80 font-titilium'>
						...
						<div className='flex mt-4 sm:justify-center sm:mt-0 gap-10'>
							...
							<a
								href={`${process.env.NEXT_PUBLIC_APP_URL}/cookies`}
								className='hover:underline hover:text-[#D5F590] transition'>
								Cookie Policy
							</a>
							<a
