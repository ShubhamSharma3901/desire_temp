...
const data = [
	{
		...
		heading: " Outstanding Entrepreneurship October, 2016",
		content:
			"National Award by Prime Minister Shri Narendra Modi for Outstanding Entrepreneurship October, 2016",
	},
	{
		img: "/asset/awards/bg/Udhyog Ratna Award.jpg",
		heading: "Udhyog Ratna Award",
		content:
			"Udhyog Ratna Award by Chief Minister of Rajasthan Smt. Vasundhra Raje Sindhiya November, 2017",
	},
	{
	...
	},
	{
		...
		heading: "Certified by Ministry of New & Renewable Energy",
		content:
			"Certified by Ministry of New & Renewable Energy (MNRE), Government of India for Solar Products",
	},
	{
		img: "/asset/Awards105.webp",
		heading: "Certified ESCO Company",
		content:
			"Certified ESCO Company by Bureau of Energy Efficiency, Government of India",
	},
	{
		img: "/asset/Awards106.webp",
		heading: "Enlisted by NABARD",
	...
	},
	{
		...
		heading: "Certified products with CE marketing",
		content:
			"Certified products with CE marketing. Tested and approved products by many NABAL Laboratories like NISE, ERDA, TUV etc.",
	},

	{
		...
		heading: "In-house R&D team",
		content:
			" Established in-house R&D team for the next gen technology development and possess many patented products",
	},
	{
		img: "/asset/Awards110.webp",
		heading: " Own Tailor made ERP",
		content:
			" Build and Implemented Own Tailor made ERP for all processes and Project Management",
	},
];
const Recognition = () => {
	return (
		<div
			className={
				"mb-20 space-y-16 flex flex-col justify-center items-center w-[90%]"
			}>
			...
			<div className='container mx-auto px-4 py-8'>
				<div className='grid xsPhone:grid-cols-1 smTablet:grid-cols-2 smLaptop:grid-cols-3 gap-8'>
					{data.map((item, index) => (
						<div
							key={index}
							className='bg-transparent  rounded-lg overflow-hidden shadow-md'>
