...
const data = [
	...
	{
		heading: "Rural Employment",
		content:
			"Programs aim to create sustainable jobs in villages through skill development and local enterprise support.",
	},
	{
		heading: "Sustainability",
		content:
			"Initiatives promote eco-friendly practices to ensure long-term environmental and social well-being.",
	},
];
	...
	return (
		<div className={"w-[90%] flex flex-col gap-20 justify-center items-center"}>
			...
			<div className='container mx-auto px-4  md:mb-[4rem] tablet:mt-[2rem]'>
				<div className='grid grid-cols-1 sm:grid-cols-2 tablet:grid-cols-2 smLaptop:grid-cols-3 smLaptop:gap-[0.5rem] gap-8'>
					{data.map((item, index) => (
						<div
							key={index}
