			...
			<div className='container mx-auto px-6 md:px-12 lg:px-20'>
				...
				<ul className='list-disc list-inside text-gray-700 mb-4  font-titilium tablet:text-[min(1.5vh,1.5vw)] text-[min(3.2vh,3.2vw)] smLaptop:text-[min(2.3vh,2.3vw)]'>
					...
					<li>
						...
						refers to Desire Energy Limited, 401, Manupasana Tower, Near Chomu
						House Circle, C - Scheme, Jaipur (Raj.) INDIA.
					</li>
					<li>
					...
					<li>
						Website refers to Desire Energy, accessible from
						www.desireenergy.com
					</li>
					<li>
				...
				<h2 className='tablet:text-[min(3vh,3vw)] text-[min(5vh,5vw)] smLaptop:text-[min(4vh,4vw)] font-semibold mt-8 mb-2 text-[#085C2C]  font-titilium'>
					COLLECTING AND USING YOUR PERSONAL DATA
				</h2>
				<h2 className='tablet:text-[min(3vh,3vw)] text-[min(5vh,5vw)] smLaptop:text-[min(4vh,4vw)] font-semibold text-[#085C2C]  font-titilium mb-2'>
					TYPES OF DATA COLLECTED
				</h2>
				<h2 className='tablet:text-[min(3vh,3vw)] text-[min(5vh,5vw)] smLaptop:text-[min(4vh,4vw)] font-semibold  text-[#085C2C]  font-titilium mb-8'>
					PERSONAL DATA
				</h2>
				<p className='text-gray-700 mb-4  font-titilium tablet:text-[min(1.5vh,1.5vw)] text-[min(3.2vh,3.2vw)] smLaptop:text-[min(2.3vh,2.3vw)]'>
				...
				<ul className='list-disc list-inside text-gray-700 mb-4  font-titilium tablet:text-[min(1.5vh,1.5vw)] text-[min(3.2vh,3.2vw)] smLaptop:text-[min(2.3vh,2.3vw)]'>
					...
					<li>By visiting this page on our website: www.desireenergy.com</li>
					<li>By phone number: 0141-4050855</li>
				</ul>
			</div>
		</div>
	);
